% unattended-upgrades-plugin-webhook(SECTION) | User Commands
%
% "February 27 2024"
...
unattended-upgrades-plugin-webhook - program to do something

# SYNOPSIS

**unattended-upgrades-plugin-webhook** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**unattended-upgrades-plugin-webhook** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **unattended-upgrades-plugin-webhook** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**unattended-upgrades-plugin-webhook** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    unattended-upgrades-plugin-webhook. See **foo.conf**(5) for further details.
...
**unattended-upgrades-plugin-webhook** provides some return codes, that can be used in scripts:
